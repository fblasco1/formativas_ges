...
_ALIAS_CLAVE: Dict[str, str] = {
    ...
    # NORTE 3C: U15/U17/U9 "NAUTICO BUCHARDO NORTE (A)" == U13 "NAUTICO BUCHARDO A"
    ...
    # OESTE 3C: U15/U9 "PORTENO ATLETICO CLUB B" == U11/U13/U17 "... BLANCO B"
    "PORTENO ATLETICO CLUB B": "PORTENO ATLETICO CLUB B BLANCO",
    # SUR 2B: U11/U13/U17/U9 "MONTE GRANDE B" == U15 "MONTE GRANDE B NEGRO"
    "MONTE GRANDE B": "MONTE GRANDE B NEGRO",
}
